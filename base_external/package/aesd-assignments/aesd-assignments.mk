...
AESD_ASSIGNMENTS_VERSION = 'a25cb77cd43bf8fff206fcce55b0dead0d1100bf'
# Note: Be sure to reference the *ssh* repository URL here (not https) to work properly
# with ssh keys and the automated build/test system.
# Your site should start with git@github.com:
AESD_ASSIGNMENTS_SITE = 'https://github.com/cu-ecen-aeld/assignments-3-and-later-johniyoods.git'
AESD_ASSIGNMENTS_SITE_METHOD = git
AESD_ASSIGNMENTS_GIT_SUBMODULES = YES

define AESD_ASSIGNMENTS_BUILD_CMDS
	$(TARGET_CC) $(TARGET_CFLAGS) -o $(@D)/finder-app/writer $(@D)/finder-app/writer.c
endef
